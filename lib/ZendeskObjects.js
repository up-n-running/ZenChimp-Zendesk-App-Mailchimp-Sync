 ...
 */
    ...
    ZendeskUser.prototype.getSalutation = function(){ this.populateNamePartsIfNecessary(); return ( this.name_parts.salutation === null ) ? "" : this.name_parts.salutation.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();}); };
    ZendeskUser.prototype.getForeName   = function(){ this.populateNamePartsIfNecessary(); return ( this.name_parts.firstName === null ) ? "" : this.name_parts.firstName.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();}); };
    ZendeskUser.prototype.getSurname    = function(){ this.populateNamePartsIfNecessary(); return  ( this.name_parts.lastName === null ) ? "" : this.name_parts.lastName.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();}); };
